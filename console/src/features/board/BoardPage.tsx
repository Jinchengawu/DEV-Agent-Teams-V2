...
export function BoardPage() {
  ...
  const board = useQuery({ queryKey: ["board", projectId], queryFn: async ({ signal }) => assertProjectScope(projectId, await request<WorkItem[]>(`/v1/board?project_id=${encodeURIComponent(projectId)}`, { signal }), "交付看板"), refetchInterval: 1500 });
