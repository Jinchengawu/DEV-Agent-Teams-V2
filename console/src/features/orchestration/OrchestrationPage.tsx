...
function LoopBodyEditor({ loop, onChange }: { loop: LoopNode; onChange: (node: LoopNode) => void }) {
  const [selectedNodeId, setSelectedNodeId] = useState<string>();
  const [selectedEdgeId, setSelectedEdgeId] = useState<string>();
